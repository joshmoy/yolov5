...
def img2label_paths(img_paths):
    """Generates label file paths from corresponding image file paths by replacing `/JPEGImages/` with `/labels/` and
    extension with `.txt`.
    """
    sa, sb = f"{os.sep}JPEGImages{os.sep}", f"{os.sep}labels{os.sep}"  # /JPEGImages/, /labels/ substrings
